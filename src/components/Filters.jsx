    ...
    return (
      <div className="flex justify-between items-center gap-x-2">
        ...
        <section className="bg-white h-11 w-48 rounded-sm flex items-center px-2 justify-center gap-2">
          <div className="flex items-center">
            <div>
              ...
              >
                <path d="M3 7H21" stroke="#FC5858" strokeWidth="1.5" strokeLinecap="round" />
                <path
                  opacity="0.34"
                  d="M6 12H18"
                  stroke="#FC5858"
                  ...
                  strokeLinecap="round"
                />
                <path d="M10 17H14" stroke="#FC5858" strokeWidth="1.5" strokeLinecap="round" />
              </svg>
            </div>
          ...
          <div>
            <span className="text-sm text-slate-800">محبوب ترین محصول</span>
          </div>
        </section>
        ...
        <section className="bg-white h-11 w-48 rounded-sm flex items-center px-2 justify-center gap-2">
          ...
          <span className="text-sm text-slate-800 text-center flex-1">
            فیلتر : برند اپل
          </span>
        </section>
      </div>
